...
// +k8s:conversion-gen=github.com/openshift/cluster-api-provider-packet/pkg/apis/equinixmetal
...
func RawExtensionFromProviderSpec(spec *EquinixMetalMachineProviderSpec) (*runtime.RawExtension, error) {
	if spec == nil {
...
func ProviderSpecFromRawExtension(rawExtension *runtime.RawExtension) (*EquinixMetalMachineProviderSpec, error) {
	if rawExtension == nil {
		return &EquinixMetalMachineProviderSpec{}, nil
	}

	spec := new(EquinixMetalMachineProviderSpec)
