...
type machineScope struct {
	...
	projectID      string
	machine        *machinev1.Machine
	providerSpec   *v1beta1.EquinixMetalMachineProviderSpec
	providerStatus *v1beta1.EquinixMetalMachineProviderStatus
...
func newMachineScope(params machineScopeParams) (*machineScope, error) {
	...
	apiKey, err := util.GetCredentialsSecret(params.coreClient, params.machine.GetNamespace(), *providerSpec)
	if err != nil {
		return nil, err
	}
	...
	if len(projectID) == 0 {
		return nil, machineapierros.InvalidMachineConfiguration("providerID was not defined for machine")
	}
